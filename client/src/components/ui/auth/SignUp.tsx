...
export default function SignUp() {
    ...
    return (
        <div className="w-[700px] bg-gradient-to-b from-slate-800/50 to-violet-800/50 py-12 px-4 sm:px-6 lg:px-8 font-main flex items-center justify-center rounded-3xl relative overflow-hidden">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            {signupMutation.error?.message?.includes(
                                'username'
                            ) && (
