...
function MessageInputField({disabled}: {disabled: boolean}){
	return (
		<div className="flex-1 h-[60%] flex items-center justify-center text-white font-bold rounded-3xl bg-[linear-gradient(90deg,rgba(13,148,136,1)0%,rgba(114,24,199,1)100%)]">
...
function SendButton(){
	return (
		<button id="sendButton" name="button" value="send" className="h-[55%] bg-violet-600 basis-18 text-center border-t-5 border-neon/30 rounded-2xl active:border active:bg-violet-600">
