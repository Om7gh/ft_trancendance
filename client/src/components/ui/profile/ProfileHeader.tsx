...
function ProfileHeader() {
  ...
  return (
    <div className="h-[15vmax] bg-slate-950/30 shadow-lg shadow-slate-900 mb-5 p-3 flex justify-around items-center">
      <div className="flex  items-center h-full gap-8  px-5 py-2">
        ...
        <div>
          ...
          <button className="text-lg text-violet-200 bg-slate-950/50 px-4 py-2 shadow shadow-slate-900 hover:bg-slate-950 transition duration-200 cursor-pointer">
            Add Friend
          </button>
        </div>
      </div>
