...
/* plugin options type object with properties:
  ...
  with signature "asunc function sendToQueue(destination, message, timeout)":
    ...
    return a promise that will be:
      if (message sent successfully)
        - resolved with true if the sended message property rpc is false.
        - resolved with reply content, if the sended message property rpc is true, and
