        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="flex flex-col items-center gap-6 bg-slate-950/70 rounded-2xl shadow-2xl w-[25vmax] py-10 px-6 text-center border border-neon/20"
                >
                    {/* Title */}
                        ...
                        {rematch.incomingOffer ? (
                            <div className="flex gap-3 justify-center">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="bg-neon px-4 py-2 rounded-lg text-slate-900 font-bold hover:bg-neon/50 transition-all duration-300"
                                ...
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="bg-violet-500 px-4 py-2 rounded-lg text-slate-100 font-bold hover:bg-violet-600 transition-all duration-300"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="bg-neon px-4 py-2 rounded-lg text-slate-900 font-bold hover:bg-neon/80 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
