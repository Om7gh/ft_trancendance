  ...
  return (
    ...
    >
      <div className="relative text-center mb-12 md:mb-24">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold relative z-10 bg-gradient-to-r from-violet-400 to-neon bg-clip-text text-transparent">
          About PingPop
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
        <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
          ...
          <div className="flex gap-4 mt-6 md:mt-8">
            <button
              ...
              className="px-4 py-2 bg-slate-700  hover:bg-slate-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
              disabled={i === 0}
              aria-label="Previous"
            >
              Previous
            ...
            <button
              ...
              className="px-4 py-2 bg-violet-500 text-white  hover:bg-violet-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
        ...
        <div className="flex items-center justify-center order-1 lg:order-2">
          <div className="w-full h-64 sm:h-80 md:h-96 bg-slate-800  flex items-center justify-center overflow-hidden shadow-lg">
            <img
      ...
      {/* Decorative Elements */}
      <div className="absolute -bottom-20 -left-20 w-40 h-40 rounded-full bg-violet-500/10 blur-3xl -z-10" />
      <div className="absolute -top-10 -right-10 w-32 h-32 rounded-full bg-neon/10 blur-3xl -z-10" />
    </section>
  );
}
