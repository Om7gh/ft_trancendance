  ...
  return (
    <Link
      ...
      className="group relative px-8 py-6 overflow-hidden bg-slate-900/50       backdrop-blur-sm w-80 sm:w-96 md:w-[28rem]
                 ...
                 before:transition-all before:duration-300 border-5 md:hover:translate-x-24 duration-300 border-neon"
    >
      ...
      <div className="relative z-10 flex items-center gap-4 justify-center">
        <BsDiagram3 className="text-5xl text-violet-500 group-hover:text-neon group-hover:rotate-12 transition-all duration-300" />
