    ...
    <div className="w-3/5 mx-auto py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-8">
        <div className="flex-1 space-y-6">
          <div className="bg-slate-800/50  p-8 border border-slate-700 shadow-lg px-4 py-2">
            {isPending ? (
          ...
          <div className="bg-slate-800/50  border border-slate-700 shadow-lg p-6">
            <IncommingTournament />
          </div>
        </div>
        ...
        <div className="lg:w-80 flex-shrink-0">
          <div className="bg-slate-800/50  p-8 border border-slate-700 shadow-lg px-6 py-4 sticky top-6 w-96">
      ...
      {/* <div className="bg-slate-800/50  border border-slate-700 shadow-lg p-6 my-5">
        <div className="flex justify-between items-center text-slate-200">
          <p>Tournament Historique</p>
          <p className="text-xl bg-neon-500 px-2 rounded-full py-1">&darr;</p>
        </div>
