...
function ActivationInput({
    ...
    return (
        <input
            ...
            onKeyDown={onKeyDown}
            autoFocus={autoFocus}
            className="border-2 border-neon w-12 h-12 mx-1 text-center rounded-md text-xl focus:border-neon focus:outline-none text-slate-200"
            ref={ref}
        />
    );
}
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-4">
            ...
            >
                ...
                <button
                    ...
                    className="bg-neon text-white px-6 py-2 rounded-md hover:bg-neon/50 disabled:bg-neon/10 transition-colors"
                >
                    {mutateActivate.status === 'pending'
                        ? 'Verifying...'
                        : 'Verify'}
