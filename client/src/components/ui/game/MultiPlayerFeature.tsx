        ...
        <section className="py-12 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900/50 to-transparent">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
                ...
                <div className="flex flex-col justify-center gap-4 md:gap-6 relative order-2 lg:order-2">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 to-neon-400 bg-clip-text text-transparent">
                    ...
                    <ul className="space-y-3 text-slate-300 text-base sm:text-lg leading-relaxed">
                        <li className="flex items-start">
                            ...
                            <span>
                                Play with friends or random opponents in
                        ...
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Global matchmaking – Find rivals at your skill
                                level instantly
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Friend battles – Invite buddies for private
                                matches
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Voice & quick chat – Trash-talk or cheer your
                                way to victory
                            </span>
                        </li>
                        <li className="flex items-start">
                    ...
                    <blockquote className="mt-4 p-4 border-l-4 border-neon-400 bg-gray-800/50 rounded-r-lg italic text-neon-300">
