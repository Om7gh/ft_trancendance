...
export default function IncomingTournament() {
  ...
  return (
    <div className="bg-slate-800/80 border border-slate-700  overflow-hidden shadow-lg hover:shadow-violet-500/10 transition-shadow">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="pt-2 text-center">
          <p className="text-xs text-slate-500">
            Starts in <span className="text-neon-400">3 days, 4 hours</span>
          </p>
        </div>
      </div>
    </div>
