...
export default function MiniChat(): JSX.Element {
    ...
    return (
        <div className="w-full h-96 flex flex-col bg-slate-900/80 rounded-lg border border-slate-700 shadow-sm">
            ...
            >
                <input
                    className="flex-1 px-3 py-2 rounded-md bg-slate-800 text-slate-100 placeholder:text-slate-400 border border-slate-700 focus:outline-none focus:ring-1 focus:ring-neon/80"
                    type="text"
                    value={input}
                ...
                <button
                    type="submit"
                    className="px-4 py-2 rounded-md bg-neon/80 text-white font-semibold disabled:opacity-60"
                    disabled={input.trim() === ''}
                >
                    Send
                </button>
