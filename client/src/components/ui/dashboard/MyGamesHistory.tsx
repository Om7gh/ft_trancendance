...
export default function MyGamesHistory() {
  ...
  return (
    <div className="bg-slate-800/50  border border-slate-700 p-5 shadow-lg">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-bold text-white">
          <span className="text-violet-400">Match</span> History
        </h3>
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-3 h-3 rounded-full ${
                    game.isWinning ? 'bg-violet-400' : 'bg-rose-400'
                  }`}
                ></div>
                <div>
              ...
              <div className="text-center">
                <span
                  className={`text-2xl font-bold ${
                    game.isWinning ? 'text-violet-400' : 'text-rose-400'
                  }`}
                >
                  {game.myPoint}
                </span>
