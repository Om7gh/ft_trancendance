                ...
                <div className="flex flex-col justify-center gap-4 md:gap-6 relative order-2 lg:order-1">
                    ...
                    <ul className="space-y-3 text-slate-300 text-base sm:text-lg leading-relaxed">
                        <li className="flex items-start">
                            ...
                            <span>
                                Compete in fast-paced ping pong tournaments and
                        ...
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Bracket-style showdowns - Battle through rounds
                                to reach the finals
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Daily & weekly events - Fresh challenges with
                                special rewards
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Leaderboards & rankings - See how you stack up
                                against rivals worldwide
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Exclusive prizes - Unlock rare paddles, balls,
                                and arenas
                            </span>
                        </li>
                    </ul>
