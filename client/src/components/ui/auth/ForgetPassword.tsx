...
function ForgetPassword({ setOpenModel }: ForgetPasswordProps): JSX.Element {
  ...
  return (
    <div className="px-5 py-6 tracking-wider w-full text-slate-100">
      <div className="text-neon-100 text-xl text-center my-5">
      ...
      <form className="text-slate-100" onSubmit={handleSubmit}>
        <p className="text-neon-100 text-center mb-3">
        ...
        <InputField
          ...
          className="pl-10 bg-gray-700/50 border-gray-600 focus:ring-2 focus:ring-violet-400 focus:border-violet-400 mt-2"
        />
