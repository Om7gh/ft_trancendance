                ...
                <div className="flex flex-col justify-center gap-4 md:gap-6 relative order-2 lg:order-1">
                    ...
                    <ul className="space-y-3 text-slate-300 text-base sm:text-lg leading-relaxed">
                        <li className="flex items-start">
                            ...
                            <span>
                                The classic head-to-head ping pong experience,
                        ...
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Ranked matches – Climb the tiers from Rookie to
                                Grandmaster
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Custom rules – Play with unique handicaps or
                                crazy power-ups
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Replays & stats – Analyze every shot to improve
                                your game
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-violet-400 mr-2">•</span>
                            <span>
                                Intense rallies – Lightning-fast physics for
                                pro-level gameplay
                            </span>
                        </li>
                    </ul>

                    <blockquote className="mt-4 p-4 border-l-4 border-neon bg-gray-800/50 rounded-r-lg italic text-neon-300">
