...
export default function Button({
  ...
  const baseStyles = ' font-medium transition-all px-4 py-3 cursor-pointer';
  const variantStyles = {
      ...
      <div className="relative group">
        ...
        <label
          ...
          className={`flex items-center justify-center gap-3 px-6 py-3 
            bg-slate-900/50 border-2 border-violet-500/30 rounded-lg 
      ...
      <div className="relative group">
        ...
        <label
          ...
          className={`flex items-center justify-center w-6 h-6 
            bg-slate-900/50 border-2 border-violet-500/50 rounded cursor-pointer
  ...
  if (type === 'password') {
    return (
      <div className="relative group">
        ...
        <div
          className={`absolute inset-0 rounded-lg bg-gradient-to-r from-violet-500 to-neon opacity-0 blur-md -z-10 transition-opacity duration-300
