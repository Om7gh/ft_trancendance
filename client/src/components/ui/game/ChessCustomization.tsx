...
import ChessSettings from './customization/ChessSettings';
import Modal from '@/components/layout/Modal';

function ChessCustomization() {
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-4 justify-center">
          <GiChessPawn className="text-5xl text-violet-500 group-hover:text-neon group-hover:rotate-12 transition-all duration-300" />
...
export default ChessCustomization;
