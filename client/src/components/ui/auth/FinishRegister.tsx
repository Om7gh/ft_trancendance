...
export default function FinishRegister() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 gap-x-8">
      ...
      <div className="w-full max-w-md bg-slate-800/50 backdrop-blur-sm  shadow-2xl overflow-hidden p-8 border-2 border-violet-400">
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center flex-col gap-6">
              <div
                className="relative w-20 h-20  bg-slate-700 border-2 border-neon-400 overflow-hidden cursor-pointer shadow-lg"
              ...
              <button
                type="button"
                onClick={triggerFileInput}
                className="px-4 py-2 border-2 border-violet-400  shadow-sm text-sm font-medium
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-violet-300">
              Player Bio{' '}
              <span className="text-neon-400/80">(10-50 characters)</span>
            </label>
            <div className="relative">
              <textarea
                ...
                minLength={10}
                name="bio"
                className="mt-1 block w-full px-4 py-3 border-2 border-violet-400  shadow-sm
          ...
          <div className="flex space-x-4 justify-between pt-4">
            <button
              type="button"
              className="px-6 py-2 border-2 border-neon  shadow-sm text-sm font-medium
