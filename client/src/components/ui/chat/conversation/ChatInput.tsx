...
function SendButton(){
	return (
		<button id="sendButton" name="button" value="send" className="h-[55%] bg-[#F97316] basis-18 text-center border-t-5 border-[#c75b0f] rounded-2xl active:border active:bg-[#ff6a00]">
...
function UnblockButton(){
	...
	return (
		<button id="unblockButton" name="button" value="unblock"
			className="w-[30%] flex justify-center items-center h-[55%] rounded-4xl bg-[#0D9488]/80 ">
