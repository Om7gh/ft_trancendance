...
function EmptyContacts(){
    ...
    <div className="h-[87%] flex flex-col justify-center items-center text-gray-300">
      <img src="src/assets/illustrations/Feeling sorry-cuate.svg"/>
...
function EmptyConversations({onAction}: {onAction: OnAction}){
    return (
    <div className="h-[87%] flex flex-col justify-center items-center text-gray-300">
        <img src="src/assets/illustrations/startConversation.svg"/>
...
function EmptyMessages(){
    return (
    <div className="h-[87%] flex flex-col justify-center items-center text-gray-300">
      <img src="src/assets/illustrations/Work chat-cuate.svg"/>
...
function ErrorStaus(){
  return (
    <div className="h-[87%] flex flex-col justify-center items-center">
      <img src="src/assets/illustrations/errorState.svg"/>
