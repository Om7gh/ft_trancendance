...
function synchronizePongState({ connection, context, setScore, setMatchState }: synchronizePongStateType ) {
    let   intervalId            = null;
...
export function Match({ connection, matchState, setMatchState }: MatchPropsType) {
    const  canvasRef            = useRef<HTMLCanvasElement | null>(null);
    const  renderingContext     = useRef<CanvasRenderingContext2D | null>(null);
    const [score, setScore]     = useState<ScoreType>({leftPlayer: 0, rightPlayer: 0});
