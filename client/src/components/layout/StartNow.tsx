...
export default function StartNow(): JSX.Element {
  ...
  return (
    <section className="p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6  border-2 border-violet-500 ring-4 ring-violet-800/50 p-4 bg-gray-900/50 backdrop-blur-sm overflow-hidden">
