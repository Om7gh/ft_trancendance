                ...
                <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
                    ...
                    <div className="flex gap-4 mt-6 md:mt-8">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-violet-500 text-white rounded-lg hover:bg-violet-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            ...
            <div className="flex justify-center gap-2 mt-8 md:mt-12">
                {data.map((_, index) => (
                    <button
                        key={index}
                        onClick={() =>
                            dispatch({ type: 'data/set', payload: index })
                        }
